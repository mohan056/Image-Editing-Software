...
class ColorData {
 public:
  ...
  /** Arithmetic operators provide shortcuts for applying multiplication
  operations to all components of a color. */
  friend ColorData operator*(const ColorData& a, float f);

  /** Arithmetic operators provide shortcuts for applying addition
  operations to all components of a color. */
  friend ColorData operator+(const ColorData& a, const ColorData& b);

  /** Arithmetic operators provide shortcuts for applying subtraction 
  operations to all components of a color. */
  friend ColorData operator-(const ColorData& a, const ColorData& b);
