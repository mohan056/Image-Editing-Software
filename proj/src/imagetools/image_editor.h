...
class ImageEditor {
 ...
 private:
  BlurFilter f_blur_;
  EdgeDetectFilter f_edge_;
  MotionBlurFilter f_motion_blur_;
  SharpenFilter f_sharpen_;
  ChannelsFilter f_channels_;
  QuantizeFilter f_quantize_;
  SaturationFilter f_saturate_;
  ThresholdFilter f_threshold_;
